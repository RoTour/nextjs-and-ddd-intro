...
import { AuthServerActionLogin } from "../BetterAuthServerActions.adapter";
...
const LoginPage = () => {
  ...
  const signInSocial = async (provider: "discord" | "github") => {
      ...
      >
        ...
        <div className="flex flex-col gap-3 px-16">
          <button
            ...
            type="button"
            className="bg-gray-800 text-white text-center rounded-md px-8 py-2 hover:bg-gray-700 transition-colors"
          >
          ...
          <button
            ...
            className="bg-indigo-600 text-white text-center rounded-md px-8 py-2 hover:bg-indigo-500 transition-colors"
          >
            Continue with Discord
          </button>
        </div>
        <Link
          href="/better-auth/register"
